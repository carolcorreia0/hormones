...
glitch_exec = {
    ...
    NR_OF_GLITCHED_CANVASES : 5,
    GLITCH_RENDER_COUNT     : 0, /* 0 or negative == glitch indefinitely ; > 0 == glich & few times and stop */
    GLITCH_INTERVAL_PROGRESSIVE : 10,
    GLITCH_INTERVAL_MIN     : 1000, /* millisecs */
    GLITCH_INTERVAL_MAX     : 1500, /* millisecs */
    DELAY_BETWEEN_FRAMES    : 10,  /* 30 milisecs delay */
    DELAY_BETWEEN_GLITCHES  : 100,
    GLITCH_REFRESH_FRAMES_INTERVAL : 5, /* refresh glitched frames after N glitches ; 0 disables this */
